...
var StyledChatIcon = styled(FiMessageCircle, {
    color: '$primary'
});
export default function Navigation() {
    return (<Row justify="space-between" align="center">
      ...
      <Link href="/walletconnect" passHref>
        <a className="navLink">
          <Avatar size="lg" css={{ cursor: 'pointer' }} color="gradient" icon={<Image alt="wallet connect icon" src="/wallet-connect-logo.svg" width={30} height={30}/>}/>
        </a>
      </Link>
